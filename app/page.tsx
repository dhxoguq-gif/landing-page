          ...
          <div className="w-full max-w-md mx-auto mb-8">
            <div className="grid grid-cols-2 gap-3 mb-4">
              <a 
                ...
                className="bg-gray-900 hover:bg-gray-800 text-white font-semibold py-4 px-4 rounded-xl text-base transition duration-300 shadow-lg hover:shadow-xl flex flex-col items-center justify-center gap-1"
              >
                <span className="text-lg">✨</span>
                <span className="text-sm underline">자격 확인하기</span>
              </a>
              <a 
                href="https://open.kakao.com/o/s4YGJB7h" 
                target="_blank"
                rel="noopener noreferrer"
                className="bg-[#FEE500] hover:bg-[#FEE500]/90 text-gray-900 font-semibold py-4 px-4 rounded-xl text-base transition duration-300 shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
              >
              ...
              <a 
                ...
                className="bg-gradient-to-r from-purple-600 to-pink-500 hover:from-purple-700 hover:to-pink-600 text-white font-semibold py-4 px-4 rounded-xl text-base transition duration-300 shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
              ...
              >
                ...
                <span className="text-sm">초대권 소지자 문의방</span>
              </a>
            </div>
            <a 
              href="#core-values"
