export default function Home() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-sky-50/30 via-blue-50/20 to-white text-gray-900">
      ...
      {/* Hero Section */}
      <section className="flex flex-col items-center justify-center min-h-screen px-4 py-20 relative overflow-hidden bg-gradient-to-b from-sky-50/20 via-blue-50/10 to-white pt-24">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-3 flex-wrap">
            <a 
              ...
              className="inline-block bg-gray-900 hover:bg-gray-800 text-white font-medium py-2.5 px-6 rounded-full text-base transition-all duration-300 shadow-sm hover:shadow-md hover:scale-105 transform active:scale-95"
            >
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-medium py-2.5 px-6 rounded-full text-base transition-all duration-300 shadow-sm hover:shadow-md hover:scale-105 transform active:scale-95"
            >
              <span className="flex items-center justify-center gap-2">
                💬 카카오톡 문의하기
              </span>
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block bg-gradient-to-r from-purple-400 to-pink-400 hover:from-purple-500 hover:to-pink-500 text-white font-medium py-2.5 px-6 rounded-full text-base transition-all duration-300 shadow-sm hover:shadow-md hover:scale-105 transform active:scale-95"
            >
      ...
      <section className="py-20 px-4 bg-white relative">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h2 className="text-4xl md:text-5xl font-semibold mb-8 text-gray-800">
            이런 고민 있으신가요?
          </h2>
      ...
      <section className="py-20 px-4 bg-sky-50/20 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <h2 className="text-4xl md:text-5xl font-semibold text-center mb-4 text-gray-800">
            다른 로테이션 모임과의
          </h2>
          <h3 className="text-3xl md:text-4xl font-semibold text-center mb-16 text-gray-700">
            차별점
          </h3>
          
          <div className="grid md:grid-cols-2 gap-6">
            {/* 차별점 1 */}
            <div className="bg-white/70 p-8 rounded-2xl border border-sky-100 hover:border-sky-200 hover:shadow-md transition-all duration-300 backdrop-blur-sm">
            ...
            <div className="bg-white/70 p-8 rounded-2xl border border-sky-100 hover:border-sky-200 hover:shadow-md transition-all duration-300 backdrop-blur-sm">
              ...
              <p className="text-gray-400 text-sm mt-2">※아르바이트생은 운영자가 돈을 주고 참가를 부탁한 사람을 말함</p>
            </div>
            ...
            <div className="bg-white/70 p-8 rounded-2xl border border-sky-100 hover:border-sky-200 hover:shadow-md transition-all duration-300 backdrop-blur-sm">
              ...
              <p className="text-gray-900 font-semibold mt-2">나만을 위한 특별한 인연, VERITAS가 끝까지 함께합니다</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-white relative">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          <h2 className="text-4xl md:text-5xl font-semibold text-center mb-16 text-gray-800">
            진행 프로세스
          </h2>
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-6 items-start">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-sky-400 flex items-center justify-center text-white font-medium text-xl shadow-sm">
                1
              </div>
              <div className="flex-1">
                <h4 className="text-2xl font-semibold mb-2 text-gray-800">신청</h4>
                <p className="text-gray-600 font-light">네이버 폼을 통해 간단하게 신청하세요!</p>
              </div>
            </div>
            ...
            <div className="flex gap-6 items-start">
              ...
              <div className="flex-1">
                <h4 className="text-2xl font-semibold mb-2 text-gray-800">검증</h4>
                <p className="text-gray-600 font-light">직장인 인증을 통해 진정성 있는 참가자만 선별!</p>
              </div>
            </div>
            ...
            <div className="flex gap-6 items-start">
              ...
              <div className="flex-1">
                <h4 className="text-2xl font-semibold mb-2 text-gray-800">인력풀 형성</h4>
                <p className="text-gray-600 font-light">검증된 참가자들로 인력풀을 구성합니다.</p>
              </div>
            </div>
            ...
            <div className="flex gap-6 items-start">
              ...
              <div className="flex-1">
                <h4 className="text-2xl font-semibold mb-2 text-gray-800">모임 날짜 공지</h4>
                <p className="text-gray-600 font-light">모임 일정을 확정하고 참가자들에게 공지합니다.</p>
              </div>
            </div>
            ...
            <div className="flex gap-6 items-start">
              ...
              <div className="flex-1">
                <h4 className="text-2xl font-semibold mb-2 text-gray-800">참여자 모집</h4>
                <p className="text-gray-600 font-light">인력풀에서 해당 모임에 참여할 분들을 모집합니다.</p>
              </div>
            </div>
            ...
            <div className="flex gap-6 items-start">
              ...
              <div className="flex-1">
                <h4 className="text-2xl font-semibold mb-2 text-gray-800">파티 진행</h4>
                <p className="text-gray-600 mb-2 font-light">편안한 분위기에서 다양한 분들과 로테이션으로 만나보세요!</p>
                ...
                <ul className="text-gray-600 space-y-1 ml-2 font-light">
            ...
            <div className="flex gap-6 items-start">
              ...
              <div className="flex-1">
                <h4 className="text-2xl font-semibold mb-2 text-gray-800">최종 투표</h4>
                <p className="text-gray-600 font-light">마음에 드는 이성 두 분 (선택 포기 가능)</p>
              </div>
            </div>
            ...
            <div className="flex gap-6 items-start">
              ...
              <div className="flex-1">
                <h4 className="text-2xl font-semibold mb-2 text-gray-800">결과 발표</h4>
            ...
            {/* Bonus Step */}
            <div className="flex gap-6 items-start">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-sky-100 border-2 border-sky-200 flex items-center justify-center text-sky-600 font-medium text-xl">
                +
              </div>
              <div className="flex-1">
                <h4 className="text-2xl font-semibold mb-2 text-gray-800">아쉬운 분을 위한 1:1 연결 서비스</h4>
      ...
      {/* Info Section */}
      <section className="py-20 px-4 bg-sky-50/20 relative">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <div className="bg-white/70 p-8 rounded-2xl border border-sky-100 space-y-6 shadow-sm backdrop-blur-sm">
            <div>
              <h3 className="text-2xl font-bold mb-4 text-gray-900">참가 자격</h3>
            ...
            <div className="pt-6 border-t border-sky-100">
              <h3 className="text-2xl font-semibold mb-4 text-gray-800">참가 비용</h3>
              <div className="mb-6">
                ...
                <div className="bg-gradient-to-r from-sky-400 via-blue-400 to-sky-500 text-white p-6 rounded-2xl text-center mb-4 shadow-md">
      ...
      {/* Warning Section */}
      <section className="py-20 px-4 bg-white border-y border-sky-100/50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-semibold text-center mb-12 text-gray-800">
            ⚠️ 주의사항 (꼭 읽어주세요!)
          </h2>
          
          <div className="bg-white/70 p-8 rounded-2xl border border-sky-200/50 shadow-sm space-y-4 backdrop-blur-sm">
      ...
      {/* FAQ Section */}
      <section className="py-20 px-4 bg-sky-50/20">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-semibold text-center mb-16 text-gray-800">
            자주 묻는 질문
          </h2>
          ...
          <div className="space-y-6">
            {/* FAQ 1 */}
            <div className="bg-white/70 p-6 rounded-2xl border border-sky-200/50 shadow-sm backdrop-blur-sm">
              <h4 className="text-xl font-semibold mb-3 text-gray-800">Q. 정말로 아르바이트생이 없나요?</h4>
            ...
            {/* FAQ 2 */}
            <div className="bg-white/70 p-6 rounded-2xl border border-sky-200/50 shadow-sm backdrop-blur-sm">
              <h4 className="text-xl font-semibold mb-3 text-gray-800">Q. 참가비용 환급 문제</h4>
            ...
            {/* FAQ 3 */}
            <div className="bg-white/70 p-6 rounded-2xl border border-sky-200/50 shadow-sm backdrop-blur-sm">
              <h4 className="text-xl font-semibold mb-3 text-gray-800">Q. 연락처 제공은 무조건 되나요?</h4>
              <p className="text-gray-600 leading-relaxed">
      ...
      {/* Closing CTA Section */}
      <section className="py-20 px-4 bg-gradient-to-b from-sky-50/20 to-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col items-center gap-2">
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="inline-block bg-gradient-to-r from-sky-400 via-blue-400 to-sky-500 hover:from-sky-500 hover:via-blue-500 hover:to-sky-600 text-white font-medium py-4 px-10 rounded-full text-lg transition-all duration-300 shadow-md hover:shadow-lg hover:scale-105 transform"
            >
              자격 확인하기
              <span className="block text-sm font-light mt-1">선착순 마감</span>
            </a>
          </div>
        </div>
      </section>
